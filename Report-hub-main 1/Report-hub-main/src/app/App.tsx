...
import { BigQueryDemoPage } from './pages/BigQueryDemo';
import { BigQueryCompleteDemoPage } from './pages/BigQueryCompleteDemo';
import BigQueryCompleteDashboardPage from './pages/BigQueryCompleteDashboard';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/bigquery-demo" element={<BigQueryDemoPage />} />
        <Route path="/bigquery-complete" element={<BigQueryCompleteDemoPage />} />
        <Route path="/bigquery-dashboard" element={<BigQueryCompleteDashboardPage />} />
