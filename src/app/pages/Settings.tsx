    ...
    <Layout>
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <h1 className="text-[28px] font-semibold text-[var(--foreground)]" style={{ fontFamily: 'Inter, sans-serif' }}>
            Settings
          </h1>
          <p className="text-[13px] text-[var(--muted-foreground)]" style={{ fontFamily: 'Inter, sans-serif' }}>
            Preferences and access context for Report Hub.
          </p>
        </div>
        <div className="text-[11px] text-[var(--muted-foreground)] bg-brand-subtle px-3 py-1.5 rounded-md" style={{ fontFamily: 'Inter, sans-serif' }}>
          System · Conceptual
        </div>
      </div>

      {/* SECTION 1: USER PROFILE */}
      <div className="bg-white rounded-[12px] border border-[var(--border)] p-6 shadow-sm">
        <div className="flex items-center gap-3 mb-5">
          <div className="w-10 h-10 rounded-full bg-brand-subtle flex items-center justify-center">
            <User className="w-5 h-5 text-brand" />
          </div>
          <h2 className="text-[18px] font-semibold text-[var(--foreground)]" style={{ fontFamily: 'Inter, sans-serif' }}>
            Your Profile
          </h2>
        </div>
        ...
        <div className="grid grid-cols-2 gap-5 mb-4">
          <div>
            <label className="block text-[11px] font-semibold text-[var(--muted-foreground)] uppercase tracking-wide mb-1.5" style={{ fontFamily: 'Inter, sans-serif' }}>
              Name
            </label>
            <div className="h-[40px] px-3 bg-gray-50 border border-[var(--border)] rounded-lg flex items-center">
              <p className="text-[13px] text-[var(--foreground)]" style={{ fontFamily: 'Inter, sans-serif' }}>
                Alex Morgan
              </p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-[12px] border border-[var(--border)] p-6 shadow-sm">
        <h2 className="text-[18px] font-semibold text-[var(--foreground)] mb-5" style={{ fontFamily: 'Inter, sans-serif' }}>
          Experience Preferences
        </h2>

        <div className="space-y-4 mb-4">
          <div>
            <label className="block text-[12px] font-semibold text-[var(--foreground)] mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="relative">
              <select 
                ...
                className="w-full h-[40px] pl-3 pr-9 bg-white border border-[var(--border)] rounded-lg text-[13px] appearance-none cursor-pointer hover:border-brand/40 transition-colors"
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-[10px] text-[var(--muted-foreground)] mt-1" style={{ fontFamily: 'Inter, sans-serif' }}>
                Auto-detected
              </p>
            </div>
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            <div className="relative">
              <input
                ...
                className="w-5 h-5 rounded border-2 border-[var(--border)] text-brand focus:ring-0 focus:ring-offset-0 cursor-pointer"
              />
            </div>
            <div className="flex-1">
              <p className="text-[13px] text-[var(--foreground)] font-medium group-hover:text-[var(--muted-foreground)] transition-colors" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="bg-white rounded-[12px] border border-[var(--border)] p-5 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-5 py-2.5 bg-white hover:bg-gray-50 text-[var(--foreground)] border border-[var(--border)] rounded-lg text-[13px] font-medium transition-colors"
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
              Back to Dashboard
            </button>
