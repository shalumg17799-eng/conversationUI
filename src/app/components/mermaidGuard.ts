// Source-level allowlist guard for the 'mermaid-artifact' node type. FRONTEND copy.
//
// This file is duplicated from backend/src/services/mermaidGuard.ts because the two
